...
function calculateAvailableSlots({
  ...
  vendors.forEach((v) => {
    ...
    // ✅ NEW: vendor-level leave check (for BOTH services)
    // If vendor is on leave for that date -> not available
    if (Array.isArray(v.markedLeaves) && v.markedLeaves.includes(date)) {
      return;
    }
...
// // old working code before implemention of vendor marked leave
// const RADIUS_KM = 10; // 10 km radius
// const TRAVEL_MIN = 30;
